...
set title "Oracle simulation, USDC/WETH .05%, 30 min window"
plot \
     'median.csv' using 2:7 with points title 'Trade', \
     'median.csv' using 2:5 with lines linestyle 1 title '30m Median', \
     'uniswap.csv' using 2:6 with lines linestyle 2 title '30m TWAP (uniswap3)', \
     'median.csv' using 2:6 with lines linestyle 3 title '30m TWAP (quantised)', \
#     'median.csv' using 2:10 with lines linestyle 5 title 'Short EMA', \
#     'median.csv' using 2:11 with lines linestyle 6 title 'Long EMA', \
#     'median.csv' using 2:12 with lines linestyle 7 title 'Short Variance', \
